...
particlesJS('particles-js',
  
  {
    "particles": {
      ...
      "color": {
        "value": ["#D98880", "#1abc9c", "#2ecc71", "#3498db", "#9b59b6","#f1c40f", "#e74c3c", "#34495e", "#8e44ad"]
      },
      "shape": {
...
register.addEventListener("click", function(){
  ...
  if (username.value == "") {
    username_error.innerHTML="Tor Username Bohaaaaa"
  }
  else{
  ...
  if (email.value == "") {
    email_error.innerHTML="Tor Email Bohaaaaa"
  }
  else{
  ...
  if (password.value == "") {
    password_error.innerHTML="Shokto Password de"
  }
  else{
  ...
  if (confirm_password.value == "") {
    confirm_password_error.innerHTML="Ager Password Abr de"
  }
  else{
